...
public class NewLogDialog extends GeneralDialog {
	...
	protected NewLogDialog(String candidateProcessName, JFrame owner, String title, String help, final ConfigurationSet configuration, boolean showLogNameAndTraces) {
		...
		// noise
		bodyPanel.add(prepareFieldLabel("Change activity name prob. (permil)"));
		bodyPanel.add(noiseActivityName);
		bodyPanel.add(prepareFieldLabel("Trace missing head prob. (permil)"));
		bodyPanel.add(noiseTraceMissingHead);
		bodyPanel.add(prepareFieldLabel("Trace missing tail prob. (permil)"));
		bodyPanel.add(noiseTraceMissingTail);
		bodyPanel.add(prepareFieldLabel("Trace missing episode prob. (permil)"));
		bodyPanel.add(noiseTraceMissingEpisode);
		bodyPanel.add(prepareFieldLabel("Perturbed event order prob. (permil)"));
		bodyPanel.add(noiseTracePerturbedOrder);
		bodyPanel.add(prepareFieldLabel("Doubled event prob. (permil)"));
		bodyPanel.add(noiseTraceDoubledEvent);
		bodyPanel.add(prepareFieldLabel("Alient event prob. (permil)"));
		bodyPanel.add(noiseTraceAlienEvent);
		bodyPanel.add(prepareFieldLabel("Integer data object error prob. (permil)"));
		bodyPanel.add(noiseIntegerData);
		bodyPanel.add(prepareFieldLabel("String data object error prob. (permil)"));
